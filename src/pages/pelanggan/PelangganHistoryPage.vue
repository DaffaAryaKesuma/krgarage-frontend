...
import PelangganHistoryFilters from "@/components/pelanggan/history/PelangganHistoryFilters.vue";
import PelangganHistoryList from "@/components/pelanggan/history/PelangganHistoryList.vue";
...
const list = ref<PelangganBooking[]>([]);
