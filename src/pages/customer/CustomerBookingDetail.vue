...
import CustomerBookingDetailInfoCards from "@/components/customer/booking-detail/CustomerBookingDetailInfoCards.vue";
import CustomerBookingDetailServiceSparepartGrid from "@/components/customer/booking-detail/CustomerBookingDetailServiceSparepartGrid.vue";
import CustomerBookingDetailNotesGrid from "@/components/customer/booking-detail/CustomerBookingDetailNotesGrid.vue";
import CustomerBookingDetailTotalSummary from "@/components/customer/booking-detail/CustomerBookingDetailTotalSummary.vue";
import { useToast } from "@/utils/useToast";
import { API_URL } from "@/utils/api";
import { getAuthHeaders } from "@/utils/auth";
import { handleApiError, logError } from "@/utils/errorHandler";
import { canCustomerCancelBooking } from "@/utils/statusBadge";
...
const canCancel = computed(() =>
  canCustomerCancelBooking(booking.value?.status || null),
);
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <div v-else-if="booking" class="space-y-6">
        <CustomerBookingDetailInfoCards :booking="booking" />

        <CustomerBookingDetailServiceSparepartGrid :booking="booking" />

        <CustomerBookingDetailNotesGrid :booking="booking" />

        <CustomerBookingDetailTotalSummary
