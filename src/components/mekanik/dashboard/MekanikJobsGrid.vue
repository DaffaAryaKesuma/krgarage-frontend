...
import type { MekanikBooking, MekanikBookingService } from "@/types/booking";
...
const getServiceName = (booking: MekanikBooking) =>
  booking.layanan
    ?.map((s: MekanikBookingService) => s.nama_layanan)
